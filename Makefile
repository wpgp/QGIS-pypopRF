...
SOURCES = \
	__init__.py \
	qgis_pypoprf.py qgis_pypoprf_dialog.py

PLUGINNAME = qgis_pypoprf

PY_FILES = \
	__init__.py \
	qgis_pypoprf.py qgis_pypoprf_dialog.py

UI_FILES = qgis_pypoprf_dialog_base.ui
...
QGISDIR=C:\Users\boris\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
